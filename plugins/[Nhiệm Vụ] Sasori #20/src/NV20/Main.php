...
if(!file_exists($this->getDataFolder() . "[NV] Sasori #20/")){
@mkdir($this->getDataFolder() . "[NV] Sasori #20/");
}
$this->quest = new Config($this->getDataFolder() . "[NV] Sasori #20/" . "Dữ liệu nhiệm vụ.yml", Config::YAML);
...
$this->chiyo = $this->getServer()->getPluginManager()->getPlugin("NV_Chiyo_19");
...
if(!$entity instanceof SlapperHuman && $entity->getName() !== "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20"){
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Done" && $this->get1($damager) == "Not" && $this->get2($damager) == "Not"){
$this->UIquest1($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Not"){
$this->UIquest2($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Done" && $this->get2($damager) == "Done" && $this->get3($damager) == "Not"){
$this->UIquest3($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Done" && $this->get3($damager) == "Done" && $this->get4($damager) == "Not"){
$this->UIquest4($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Done" && $this->get4($damager) == "Done" && $this->get5($damager) == "Not"){
$this->UIquest5($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Done" && $this->get5($damager) == "Done" && $this->get6($damager) == "Not"){
$this->UIquest6($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Done" && $this->get6($damager) == "Done" && $this->get7($damager) == "Not"){
$this->UIquest7($damager);
return true;
}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->get7($damager) == "Done"){
$this->UIthongbao($damager, "§f•§a Nhẫn Giả đã hoàn thành nhiệm vụ của NPC này!");
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20" && $this->chiyo->get7($damager) == "Not"){
$this->UIthongbao($damager, "§f•§aNgươi muốn chết hay sao mà xông vô đây. Cút");
return true;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20");
$form->setContent("§fNgươi là ai sao dám xong vào đây");
...
$form->setContent("§fTa đến để cứu Gaara. Thả cậu ấy ra");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20");
$form->setContent("§fNgươi nói thả là thả à.\n Ngươi nghỉ mình ngươi chống lại dc ta à.");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20");
$form->setContent("§fNgươi sẽ phải trả giá đắt cho việc này. Chết đi này...!\n Ngươi chết thì nhiệm vụ sẽ thất bại");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20");
$form->setContent("§fNgươi vẫn còn sống à.");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20");
$form->setContent("§fNgươi giỏi lắm. Ta sẽ đến tìm ngươi sau");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$this->nv->setNV($player, "Giải Cứu", "Gaara", "-340, 4, -303");
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Sasori §6#20");
