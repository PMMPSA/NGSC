...
if(!file_exists($this->getDataFolder() . "[NV] Naruto Trẻ #6/")){
@mkdir($this->getDataFolder() . "[NV] Naruto Trẻ #6/");
}
$this->quest = new Config($this->getDataFolder() . "[NV] Naruto Trẻ #6/" . "Dữ liệu nhiệm vụ.yml", Config::YAML);
...
if(!$entity instanceof SlapperHuman && $entity->getName() !== "§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6"){
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6" && $this->tazuna->get5($damager) == "Done" && $this->get1($damager) == "Not" && $this->get2($damager) == "Not" && $this->get3($damager) == "Not"){
$this->UIquest1($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6" && $this->tazuna->get5($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Not" && $this->get3($damager) == "Not"){
$this->UIquest2($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6" && $this->tazuna->get5($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Done" && $this->get3($damager) == "Not"){
$this->UIquest3($damager);
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6" && $this->get3($damager) == "Done"){
$this->UIthongbao($damager, "§f•§a Nhẫn Giả đã hoàn thành nhiệm vụ của NPC này!");
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6" && $this->tazuna->get5($damager) == "Not" && $this->get1($damager) == "Not"){
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6");
$form->setContent("§fCái gì, ông đuổi được bọn phá cầu rồi hả ʕ •̀ o •́ ʔ");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6");
$form->setContent("§fTui còn chưa biết cách để vượt qua nhiệm vụ đó nữa nè, ông chỉ tui đi.");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$this->nv->setNV($player, "Báo Cáo", "Thầy Kakashi", "34, 4, 245");
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Naruto §6#6");
$form->setContent("§fHả? Đi ra Thung Lũng Tận Cùng để thương lượng với Haku hả? ... Cũng được thui...\n\n§f•§c 300§a EXP\n\n");
