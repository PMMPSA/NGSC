...
if(!file_exists($this->getDataFolder() . "[NV] Sasuke #23/")){
@mkdir($this->getDataFolder() . "[NV] Sasuke #23/");
}
$this->quest = new Config($this->getDataFolder() . "[NV] Sasuke #23/" . "Dữ liệu nhiệm vụ.yml", Config::YAML);
...
$this->orochimaru = $this->getServer()->getPluginManager()->getPlugin("NV_Orochimaru_24");
...
if(!$entity instanceof SlapperHuman && $entity->getName() !== "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23"){
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->chiyo->get7($damager) == "Done" && $this->get1($damager) == "Not" && $this->get2($damager) == "Not"){
$this->UIquest1($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->chiyo->get7($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Not"){
$this->UIquest2($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->chiyo->get7($damager) == "Done" && $this->get2($damager) == "Done" && $this->get3($damager) == "Not"){
$this->UIquest3($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->chiyo->get7($damager) == "Done" && $this->get3($damager) == "Done" && $this->get4($damager) == "Not"){
$this->UIquest4($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->orochimaru->get7($damager) == "Done" && $this->get4($damager) == "Done" && $this->get5($damager) == "Not"){
$this->UIquest5($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->orochimaru->get7($damager) == "Done" && $this->get5($damager) == "Done" && $this->get6($damager) == "Not"){
$this->UIquest6($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->orochimaru->get7($damager) == "Done" && $this->get6($damager) == "Done" && $this->get7($damager) == "Not"){
$this->UIquest7($damager);
return true;
}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->get7($damager) == "Done"){
$this->UIthongbao($damager, "§f•§a Nhẫn Giả đã hoàn thành nhiệm vụ của NPC này!");
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->chiyo->get7($damager) == "Not"){
$this->UIthongbao($damager, "§f•§a Ngươi là ai muốn chết hay sao mà đến đây");
$player->setHealth($player->getHealth()-80);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23" && $this->orochimaru->get7($damager) == "Not"){
$this->UIthongbao($damager, "§f•§a Ta còn có việc không thể rời khỏi");
return true;
}
}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23");
...
$form->setContent("§fCuối cùng ta cũng tìm được cậu rồi. Đi thôi ta sẽ đưa cậu về...");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23");
$form->setContent("§fTa không về. Ta không cần ngươi giúp. Ngươi tránh ra");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§6".$player->getName());
$form->setContent("§fTa theo lệnh Hokage đến đưa cậu về. Naruto cũng đang chờ cậu");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
switch($result){
case 0:
$player->addTitle("§l§a【§6HOÀN THÀNH§a】\n§r§cChạy ngay đi!\n\n\n§f➣§aTiếp theo: §cTìm Orochimaru");
$this->level->addExp($player, 2000);
$this->bac->addBac($player, 50);
$this->xu->addXu($player, 2000);
$this->chakra->addChakra($player, 50);
$this->nv->setNV($player, "Đối kháng", "Orochimaru", "x, x, x");
$this->setDone4($player);
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23");
$form->setContent("§fNgươi đi đi Orochimaru tới rồi kìa. Nếu không kịp hắn sẽ giết cả ngươi đấy.\n\n§f•§c 2000§a EXP\n\n§f•§c 2000§a Xu\n\n§f•§c 50§a Bạc\n\n§f•§c 50§a Chakra Tổng\n\n");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23");
$form->setContent("§fNgươi thắng được Orochimaru rồi à");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23");
$form->setContent("§fThôi được rồi. Ngươi về trước đi. Ta sẽ về sau...");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$dan_hp = Item::get(340, 0, 1);
$dan_hp->setCustomName("§l§c~!§e Sách Ám Bộ§c !~");
$player->getInventory()->addItem($dan_hp);
$this->setDone7($player);
$this->nv->setNV($player, "Trở Về: LV 500", "Đối kháng Akatsuki", "x, x, x");
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Uchiha Sasuke §6#23");
$form->setContent("§fTa cho ngươi thứ này. Nó sẽ giúp ngươi mạnh hơn\n\n§f•§c 6000§a EXP\n\n§f•§c 500§a Xu\n\n§f•§c 100§a Bạc\n\n§f•§c 10§a Vàng\n\n");
