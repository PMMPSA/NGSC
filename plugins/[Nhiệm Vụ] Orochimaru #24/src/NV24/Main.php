...
if(!file_exists($this->getDataFolder() . "[NV] Orochimaru #24/")){
@mkdir($this->getDataFolder() . "[NV] Orochimaru #24/");
}
$this->quest = new Config($this->getDataFolder() . "[NV] Orochimaru #24/" . "Dữ liệu nhiệm vụ.yml", Config::YAML);
...
$this->sasuke = $this->getServer()->getPluginManager()->getPlugin("NV_Sasuke_23");
...
if(!$entity instanceof SlapperHuman && $entity->getName() !== "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24"){
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sasuke->get4($damager) == "Done" && $this->get1($damager) == "Not" && $this->get2($damager) == "Not"){
$this->UIquest1($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sasuke->get4($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Not"){
$this->UIquest2($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sasuke->get4($damager) == "Done" && $this->get2($damager) == "Done" && $this->get3($damager) == "Not"){
$this->UIquest3($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sasuke->get4($damager) == "Done" && $this->get3($damager) == "Done" && $this->get4($damager) == "Not"){
$this->UIquest4($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sm->getSucManh($damager) >= 6000000 && $this->get4($damager) == "Done" && $this->get5($damager) == "Not"){
$this->UIquest5($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sm->getSucManh($damager) >= 6000000 && $this->get5($damager) == "Done" && $this->get6($damager) == "Not"){
$this->UIquest6($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sm->getSucManh($damager) >= 6000000 && $this->get6($damager) == "Done" && $this->get7($damager) == "Not"){
$this->UIquest7($damager);
return true;
}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->get7($damager) == "Done"){
$this->UIthongbao($damager, "§f•§a Nhẫn Giả đã hoàn thành nhiệm vụ của NPC này!");
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sasuke->get4($damager) == "Not"){
$this->UIthongbao($damager, "§f•§a Ngươi gan bằng trời dám đến đây");
$player->setHealth($player->getHealth()-100);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24" && $this->sm->getSucManh($damager) < 6000000){
$this->UIthongbao($damager, "§f•§a Sức mạnh của ngươi chưa đủ để đánh với ta đâu\nYêu cầu: 6.000.000 Sức Mạnh");
return true;
}
}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24");
$form->setContent("§fNgươi là ai. Người tìm ta co việc gì lại còn dám xâm nhập vào chổ của ta");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24");
$form->setContent("§fNgươi muốn chết ta sẽ cho ngươi tội nguyện.!");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setContent("§fTa đến đây không phải để cãi với ngươi. Ta đến để đưa Sasuke trở về.");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24");
$form->setContent("§fNgươi có bản lĩnh đó sao. Vậy hãy thắng ta trước đã.\n\n§f•§c 3000§a EXP\n\n§f•§c 3000§a Xu\n\n§f•§c 100§a Bạc\n\n§f•§c 100§a Chakra Tổng\n\n");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24");
$form->setContent("§fNgươi giỏi đó. Thăng tiến cũng mau đấy. Sức mạnh đạt 6.000.000 chắc máu ngươi cũng gia tăng thêm.");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24");
$form->setContent("§fNgươi chịu được 1 chiêu của ta thì ta sẽ cho ngươi gặp Sasuke");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
switch($result){
case 0:
$player->setHealth($player->getHealth()-312);
$player->addTitle("§l§a【§6HOÀN THÀNH§a】\n§r§cNhẫn Giả đã hoàn thành N.Vụ!\n\n\n§f➣§aTiếp theo: §cSasuke");
$this->level->addExp($player, 5000);
$this->setDone7($player);
$this->nv->setNV($player, "Về", "Sasuke", "x, x, x");
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Orochimaru §6#24");
$form->setContent("§fNhận Lấy\n\n§f•§c 5000§a EXP");
