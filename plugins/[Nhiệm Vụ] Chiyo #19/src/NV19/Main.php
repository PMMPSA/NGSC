...
if(!file_exists($this->getDataFolder() . "[NV] Chiyo #19/")){
@mkdir($this->getDataFolder() . "[NV] Chiyo #19/");
}
$this->quest = new Config($this->getDataFolder() . "[NV] Chiyo #19/" . "Dữ liệu nhiệm vụ.yml", Config::YAML);
...
$this->kankuro = $this->getServer()->getPluginManager()->getPlugin("NV_Kankuro_18");
$this->kankuro = $this->getServer()->getPluginManager()->getPlugin("NV_Kankuro_18");
...
if(!$entity instanceof SlapperHuman && $entity->getName() !== "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19"){
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get4($damager) == "Done" && $this->get1($damager) == "Not" && $this->get2($damager) == "Not"){
$this->UIquest1($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get4($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Not"){
$this->UIquest2($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get4($damager) == "Done" && $this->get2($damager) == "Done" && $this->get3($damager) == "Not"){
$this->UIquest3($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get7($damager) == "Done" && $this->get3($damager) == "Done" && $this->get4($damager) == "Not"){
$this->UIquest4($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get7($damager) == "Done" && $this->get4($damager) == "Done" && $this->get5($damager) == "Not"){
$this->UIquest5($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get7($damager) == "Done" && $this->get5($damager) == "Done" && $this->get6($damager) == "Not"){
$this->UIquest6($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get7($damager) == "Done" && $this->get6($damager) == "Done" && $this->get7($damager) == "Not"){
$this->UIquest7($damager);
return true;
}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->get7($damager) == "Done"){
$this->UIthongbao($damager, "§f•§a Nhẫn Giả đã hoàn thành nhiệm vụ của NPC này!");
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get4($damager) == "Not"){
$this->UIthongbao($damager, "§f•§aNgươi là ai đến Làng Cát có việc gì ?");
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19" && $this->kankuro->get7($damager) == "Not"){
$this->UIthongbao($damager, "§f•§aChúng ta chuẩn bị lên đường thôi.");
return true;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19");
...
$form->setContent("§fChào bà Kankuro kêu tôi lên nói là mình có thể xuất phát đi cứu Kazekage");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19");
$form->setContent("§fLàng Lá chỉ đưa mình ngươi tới thôi à. Ngươi nên đi tập luyện để mạnh hơn");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$this->nv->setNV($player, "Đạt Cấp 75", "Kankuro", "1700, 64, -2823");
$this->setDone3($player);
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19");
$form->setContent("§fHãy đi luyện tập để mạnh hơn..\n\n§f•§c 1000§a Kinh Nghiệm\n\n§f•§c 100§a Xu\n\n§f•§c 30§a Bạc\n\n§f•§c 5§a Vàng\n\n");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19");
$form->setContent("§fTốt rồi chúng ta đi thôi");
$form->addButton("§l§1HOÀN THÀNH ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§6".$player->getName());
$form->setContent("§fBà có cần chuẩn bị gì ko. hay đem theo thuốc không?");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19");
$form->setContent("§fTa không cần ta còn khỏe hơn ngươi nhiều. Ranh con này");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$this->nv->setNV($player, "Giải Cứu Kazekage", "Sasori", "-329, 4, -330");
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Chiyo §6#19");
$form->setContent("§fđi thôi. không nói nhiều nữa. trễ rồi.\n\n§f•§c 1000§a EXP\n\n§f•§c 500§a Xu\n\n§f•§c 100§a Bạc\n\n§f•§c 5§a Vàng\n\n");
