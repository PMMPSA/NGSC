...
if(!file_exists($this->getDataFolder() . "[NV] Jiraiya #11/")){
@mkdir($this->getDataFolder() . "[NV] Jiraiya #11/");
}
$this->quest = new Config($this->getDataFolder() . "[NV] Jiraiya #11/" . "Dữ liệu nhiệm vụ.yml", Config::YAML);
...
$this->jiraiya = $this->getServer()->getPluginManager()->getPlugin("NV_Jiraiya_9");
$this->kakashi = $this->getServer()->getPluginManager()->getPlugin("NV_Kakashi_10");
...
if(!$entity instanceof SlapperHuman && $entity->getName() !== "§l§e【§cNhiệm Vụ§e】§r§f jiraiya §6#11"){
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Jiraiya §6#11" && $this->jiraiya->get7($damager) == "Done" && $this->get1($damager) == "Not" && $this->get2($damager) == "Not"){
$this->UIquest1($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Jiraiya §6#11" && $this->jiraiya->get7($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Not"){
$this->UIquest2($damager);
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Jiraiya §6#11" && $this->get2($damager) == "Done"){
$this->UIthongbao($damager, "§f•§a Nhẫn Giả đã hoàn thành nhiệm vụ của NPC này!");
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Jiraiya §6#11" && $this->jiraiya->get7($damager) == "Not" && $this->get1($damager) == "Not"){
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Jiraiya §6#11");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Jiraiya §6#11");
$form->setContent("§fCấp độ ngươi còn quá thấp. Hãy tập luyện lên lv 20 đi");
...
$this->nv->setNV($player, "Lên Lv 20", "Stunade", "24, 4, -2");
break;
}
});
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Jiraiya §6#11");
$form->setContent("§fNgười tập luyện cấp độ lên lv 20 đi. Rồi đến gặp Stunade.\nTa gặp ngươi sau.\n\n§f•§c 2000§a EXP\n\n");
