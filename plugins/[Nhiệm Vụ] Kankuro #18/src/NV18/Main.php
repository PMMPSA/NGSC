...
if(!file_exists($this->getDataFolder() . "[NV] Kankuro #18/")){
@mkdir($this->getDataFolder() . "[NV] Kankuro #18/");
}
$this->quest = new Config($this->getDataFolder() . "[NV] Kankuro #18/" . "Dữ liệu nhiệm vụ.yml", Config::YAML);
...
$this->sakura = $this->getServer()->getPluginManager()->getPlugin("NV_Sakura_17");
...
if(!$entity instanceof SlapperHuman && $entity->getName() !== "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18"){
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->sakura->get3($damager) == "Done" && $this->get1($damager) == "Not" && $this->get2($damager) == "Not"){
$this->UIquest1($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->sakura->get3($damager) == "Done" && $this->get1($damager) == "Done" && $this->get2($damager) == "Not"){
$this->UIquest2($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->sakura->get3($damager) == "Done" && $this->get2($damager) == "Done" && $this->get3($damager) == "Not"){
$this->UIquest3($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->sakura->get3($damager) == "Done" && $this->get3($damager) == "Done" && $this->get4($damager) == "Not"){
$this->UIquest4($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->level->getLevel($damager) >= 75 && $this->get4($damager) == "Done" && $this->get5($damager) == "Not"){
$this->UIquest5($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->level->getLevel($damager) >= 75 && $this->get5($damager) == "Done" && $this->get6($damager) == "Not"){
$this->UIquest6($damager);
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->level->getLevel($damager) >= 75 && $this->get6($damager) == "Done" && $this->get7($damager) == "Not"){
$this->UIquest7($damager);
return true;
}
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->get7($damager) == "Done"){
$this->UIthongbao($damager, "§f•§a Nhẫn Giả đã hoàn thành nhiệm vụ của NPC này!");
return true;
}

if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->sakura->get3($damager) == "Not"){
$this->UIthongbao($damager, "§f•§aCậu là người Làng nào đến đây có việc chi ?");
return true;
}
if($entity instanceof SlapperHuman && $entity->getName() == "§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18" && $this->level->getLevel($damager) < 75){
$this->UIthongbao($damager, "§f•§aTôi đang phải luyện tập mạnh hơn. Cậu cũng đi luyện tập đi");
return true;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18");
$form->setContent("§fCậu là người được Hokage làng lá phái đến giúp chúng tôi phải ko ?");
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18");
$form->setContent("§fVậy quá tốt rồi. Kazekage không may bị bắt. Hãy giúp chúng tôi cứu Kazekage");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18");
$form->setContent("§fcó vẽ như cậu đã mạnh hơn nhiều rồi. Chúng ta đi thôi");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18");
$form->setContent("§fAkatsuki rất gian manh. Coi chừng bị phục kích");
$form->addButton("§l§1Tiếp tục đối thoại ➣");
$form->sendToPlayer($player);
return $form;
}
...
$form->setTitle("§l§e【§cNhiệm Vụ§e】§r§f Kankuro §6#18");
$form->setContent("§fLên kêu bà Chiyo chúng ta cùng đi thôi...!\n\n§f•§c 1000§a EXP\n\n§f•§c 50§a Xu\n\n§f•§c 50§a Bạc\n\n§f•§c 5§a Vàng\n\n");
